...
Decaimiento exponencial: una EDO escalar y comparación con solución exacta.

Oscilador armónico: EDO de segundo orden convertida en un sistema de dos EDO; se grafica el espacio de fase.

Dos entradas simultáneas: una salida sometida a una entrada sinusoidal y a un pulso.

Duffing forzado: sistema no lineal, forzado periódico y sección de Poincaré.

Lorenz: tres variables acopladas y no lineales.

Convergencia de RK4: demuestra numéricamente los órdenes local 5 y global 4.

Problema sin unicidad: $y'=2\sqrt y,\ y(0)=0$, usado para mostrar que la convergencia también depende de que el problema diferencial esté bien planteado.
